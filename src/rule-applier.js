...
module.exports = class RuleApplier {
  ...
  applyRules (rules, context) {
    for (const rule of rules) {
      ...
      const ruleApplier = eval("new " + rule + "(this.config,this.issueDataProvider,this.pullRequestDataProvider,this.projectCardDataProvider,this.githubApiClient,this.logger);");
